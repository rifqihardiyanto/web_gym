        ...
        <div class="mt-3">
            ...
            <div class="modal modal-top fade" id="modal-form" tabindex="-1">
                <div class="modal-dialog">
                    <form class="form-review modal-content">
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        placeholder="Enter review" name="nama_review" />
                                </div>
                            </div>
                            <div class="row g-2">
        ...
        $(function() {
            ...
            $(document).on('click', '.modal-ubah', function() {
                ...
                $.get('api/reviews/' + id, function({
                    ...
                    $('input[name="nama_review"]').val(data.nama_review);
