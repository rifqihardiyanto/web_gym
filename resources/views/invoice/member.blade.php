            ...
            <div class="cs-invoice_in" id="download_section">
                <div class="cs-invoice_head cs-type1 cs-mb25">
                    ...
                    <div class="cs-invoice_right cs-text_right">
                        <div class="cs-logo cs-mb5"><img src="{{ asset('assets/img/logo.svg') }}" alt="Logo"></div>
                    </div>
                </div>
                <div class="cs-invoice_head cs-mb10">
                    ...
                    <div class="cs-invoice_right cs-text_right">
                        ...
                        <p>
                            Prasasti GYM <br>
                            Perum Madukoro Asri, Bumireso, <br>
                            Kec. Wonosobo,
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg">ID Member</th>
                                        <th class="cs-width_4 cs-semi_bold cs-primary_color cs-focus_bg">Exp Date
                                        </th>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="cs-width_3">{{  $data->category->name }}</td>
                                        <td class="cs-width_3">PG-{{  $data->id }}</td>
                                        <td class="cs-width_4">{{ $data->exp }}</td>
                                        <td class="cs-width_2 cs-text_right">Rp. {{ number_format($data->category->biaya) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                                ...
                                <tbody>
                                    <tr class="cs-border_none">
                                        ...
                                        <td
                                            ...
                                            Rp. {{ number_format($data->category->biaya) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
